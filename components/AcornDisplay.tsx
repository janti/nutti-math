...
export default function AcornDisplay({ 
  ...
  // If showing many acorns, group them nicely
    ...
    <div className="flex items-center justify-center gap-1 flex-wrap max-w-md mx-auto">
      {Array.from({ length: maxAcorns }, (_, i) => {
        ...
        return (
          <div
            key={i}
            className={`${sizeClass} relative transition-transform duration-300 flex items-center justify-center ${
              isEarned ? 'scale-100' : 'scale-75 opacity-30'
            }`}
          >
