...
export default function Results() {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-nutti-secondary/30 via-white to-blue-50/40 py-4">
      <div className="max-w-4xl mx-auto p-4 min-h-full px-4">
        <div className="bg-white/90 backdrop-blur-sm border border-gray-200 shadow-xl rounded-2xl p-6 min-h-full flex flex-col">
          {/* Header */}
          <div className="mb-2">
