...
export default function LandingPage() {
  ...
  return (
    <div className="max-h-[800px] h-[800px] bg-gradient-to-br from-blue-50 via-white to-green-50 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-3 gap-6 items-center mb-8 flex-1">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="text-center">
              <Link
                href={`/${locale}/menu`}
                className="group inline-flex items-center justify-center bg-gradient-to-r from-nutti-primary via-blue-500 to-purple-600 text-white text-lg md:text-xl font-bold px-6 md:px-8 py-3 md:py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
              >
            ...
            <div className="space-y-3">
              <div className="group p-3 rounded-xl bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 transition-all duration-300 hover:scale-105 border border-blue-200">
              ...
              <div className="group p-3 rounded-xl bg-gradient-to-r from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 transition-all duration-300 hover:scale-105 border border-green-200">
                <div className="flex items-center gap-3">
              ...
              <div className="group p-3 rounded-xl bg-gradient-to-r from-yellow-50 to-yellow-100 hover:from-yellow-100 hover:to-yellow-200 transition-all duration-300 hover:scale-105 border border-yellow-200">
                <div className="flex items-center gap-3">
                  <span className="text-2xl group-hover:animate-bounce">🏆</span>
                  <div>
