...
import { pickFacts, factPool } from '@/lib/game'
...
export default function MultiplicationSetup() {
  ...
  const [range, setRange] = useState<'1-5'|'1-10'|'6-10'|'2-12'|'mix'>('1-10')
  ...
  const startNewGame = () => {
    ...
    console.log('Multiplication Setup: Started new game:', rounds, 'rounds,', range, 'multiplication tables')
  ...
  const precomputeFirstRoundFacts = () => {
    ...
    console.log('Multiplication Setup: Precomputed round 1 facts')
  }
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-6 space-y-4">
          ...
          <div className="text-center mb-4">
            <div className="text-xl mb-2">{t('icons.gameTitle')}</div>
            <NuttiBadge />
            <h1 className="text-2xl font-extrabold mb-2 text-nutti-teal">{t('gameModes.multiplication.name')}</h1>
            <p className="text-base text-nutti-orange font-semibold bg-white/70 rounded-xl p-3 border border-nutti-beige">
              {t('gameModes.multiplication.description')}
            </p>
          </div>
          
          {/* Main content - normal grid */}
      ...
      <div className="mt-6 pt-4 border-t border-gray-100">
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            >
              {t('icons.start')} {t('home.startGame')}
            </button>
          </div>
